...
*     [dimension]
      ...
      PARAMETER  ( NLEV0 = 17, NVAR1 = 7, NLEVMX = 20 )
*
*     [work]
...
*
      ...
      DATA KLEV1 / NLEV0, 8, 8, NLEV0, NLEV0, NLEV0, 12 /
...
C     2022.11.15
      WRITE(*, *) DAT0(0, 0), DAT0(0, 1), DAT0(0, 2), DAT0(0, 3)
      WRITE(*, *) DAT0(1, 0), DAT0(1, 1), DAT0(1, 2), DAT0(1, 3)
      WRITE(*, *)
      STOP
C     2022.11.15
