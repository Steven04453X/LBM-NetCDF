...
C       2022.11.04: Ziming Chen
      CHARACTER*700 CFM          !! input file name (matrix A)
      CHARACTER*700 CFR          !! input file name (rhs)
      CHARACTER*700 CFS          !! output file name (temporary)
      CHARACTER*700 CFG          !! output file name (grads)
C       2022.11.04: Ziming Chen
